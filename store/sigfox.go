...
func CreateSigfoxDataAdvancedMessage(c context.Context, message *sigfox.MessageDataAdvanced) error {
	return FromContext(c).CreateSigfoxDataAdvancedMessage(message)
}
