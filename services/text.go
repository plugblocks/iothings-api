...
type TextSender interface {
	SendAlertText(c *gin.Context, user *models.User, device *models.Device, observation *models.Observation, message string, templateLink string) error
...
func (s *TextSenderParams) SendAlertText(c *gin.Context, user *models.User, device *models.Device, observation *models.Observation, message string, templateLink string) error {
	data := models.TextData{PhoneNumber: user.Phone, Message: message}
	utils.CheckErr(s.SendText(c, data))
